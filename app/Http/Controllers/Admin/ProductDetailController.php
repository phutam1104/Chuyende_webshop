...
class ProductDetailController extends Controller
{
    ...
    public function index($product_id)
    {
        ...
        return view('admincp.adminpages.product.detail.index',compact('product','productDetails'));
    }
    ...
    {
        $product=$this->productService->find($product_id);
        return view('admincp.adminpages.product.detail.create',compact('product'));
    ...
    public function edit($product_id,$product_detail_id)
    {
        ...
        return view('admincp.adminpages.product.detail.edit',compact('product','productDetail'));
    }
