...
class ProductCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admincp.adminpages.category.index',compact('productCategories'));
    }
    ...
    {
        return view('admincp.adminpages.category.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admincp.adminpages.category.edit',compact('productCategory'));
    }
